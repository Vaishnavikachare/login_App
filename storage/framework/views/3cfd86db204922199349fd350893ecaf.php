...
<div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="p-6 text-gray-900">
                <h3 style="color:red">Register a New User</h3>
                <br>
                <form method="POST" action="<?php echo e(route('store_sub_user')); ?>">
                    <?php echo csrf_field(); ?>
                    <!-- <?php echo e(Auth::user()->id); ?> -->
                    <input type="hidden" name="parent_user_id" value="<?php echo e(Auth::user()->id); ?>">
                    <!-- Name -->
                    <div>
...
<?php endif; ?>
<?php /**PATH D:\xampp_8_2_4\htdocs\login_App\resources\views/profile/create_user.blade.php ENDPATH**/ ?>